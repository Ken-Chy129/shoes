...
@Component
public class DatabaseStockXReplenishmentTaskRecorder implements StockXReplenishmentTaskRecorder {

    private final TaskMapper taskMapper;
    private final TaskItemMapper taskItemMapper;

    public DatabaseStockXReplenishmentTaskRecorder(TaskMapper taskMapper, TaskItemMapper taskItemMapper) {
