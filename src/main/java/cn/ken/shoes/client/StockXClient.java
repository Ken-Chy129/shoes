...
public class StockXClient {
    ...
    public List<StockXItemDO> queryHotItemsByBrand(String brand, Integer pageIndex) {
        ...
        for (JSONObject item : itemList) {
            ...
            stockXItemDO.setProductType(node.getString("productType"));
