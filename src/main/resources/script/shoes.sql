...
(
    ...
    model_name        VARCHAR(128) NULL COMMENT 'eBay型号/Model',
    product_line      VARCHAR(128) NULL COMMENT 'eBay产品线/Product Line',
    country_of_origin VARCHAR(64)  NULL COMMENT '商品原产国，不根据仓库推断',
...
(
    ...
    sku            VARCHAR(50)  NULL     COMMENT 'eBay卖家SKU',
    offer_id       VARCHAR(64)  NULL     COMMENT 'eBay Offer ID',
    ...
    order_number   VARCHAR(64)  NULL     COMMENT 'StockX订单号',
    order_status   VARCHAR(32)  NULL     COMMENT 'StockX订单状态',
    currency_code  VARCHAR(8)   NULL     COMMENT '订单币种',
    sale_price     DECIMAL(12,2) NULL    COMMENT '出售价格',
    payout_amount  DECIMAL(12,2) NULL    COMMENT '预计或实际货款',
    purchase_order_number VARCHAR(64) NULL COMMENT 'StockX原购买订单号',
    purchase_price DECIMAL(12,2) NULL COMMENT 'StockX原购买成交价（非含税费总成本）',
    purchase_currency_code VARCHAR(10) NULL COMMENT 'StockX原购买币种',
    sold_on        DATETIME     NULL     COMMENT '出售日期',
    ...
    highest_bid_price DECIMAL(10,2) NULL COMMENT 'StockX市场最高求购价',
    highest_bid_count INT NULL COMMENT 'StockX市场最高求购价数量',
    second_highest_bid_price DECIMAL(10,2) NULL COMMENT 'StockX市场第二档求购价',
    second_highest_bid_count INT NULL COMMENT 'StockX市场第二档求购数量',
    average_sale_price_7d DECIMAL(10,2) NULL COMMENT 'StockX最近7天平均成交价',
    median_sale_price_7d DECIMAL(10,2) NULL COMMENT 'StockX最近7天成交中位价',
    sales_count_7d INT NULL COMMENT 'StockX最近7天成交量',
    average_sale_price_30d DECIMAL(10,2) NULL COMMENT 'StockX最近30天平均成交价',
    median_sale_price_30d DECIMAL(10,2) NULL COMMENT 'StockX最近30天成交中位价',
    sales_count_30d INT NULL COMMENT 'StockX最近30天成交量',
    average_sale_price_90d DECIMAL(10,2) NULL COMMENT 'StockX最近90天平均成交价',
    median_sale_price_90d DECIMAL(10,2) NULL COMMENT 'StockX最近90天成交中位价',
    sales_count_90d INT NULL COMMENT 'StockX最近90天成交量',
    recommended_bid DECIMAL(10,2) NULL COMMENT 'StockX建议出价',
    reference_sale_price DECIMAL(10,2) NULL COMMENT '建议所用成交参考价',
    reference_price_label VARCHAR(32) NULL COMMENT '成交参考价说明',
    sales_activity VARCHAR(16) NULL COMMENT '成交活跃度',
    sales_trend VARCHAR(16) NULL COMMENT '近期走势',
